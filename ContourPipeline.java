...
public class ContourPipeline extends OpenCvPipeline {
    ...
    // Pink, the default color (red)                     Y      Cr     Cb    (Do not change Y)
    public static Scalar scalarLowerYCrCb = new Scalar(0.0, 150.0, 100.0);
    public static Scalar scalarUpperYCrCb = new Scalar(255.0, 255.0, 255.0);

    // Yellow, freight or ducks!
    //public static Scalar scalarLowerYCrCb = new Scalar(176.0, 113.0, 50.0);
    //public static Scalar scalarUpperYCrCb = new Scalar(137.0, 115.0, 151.0);
